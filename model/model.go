...
type GroupMessageTables interface {
	GroupMessageTableRow | GroupMessageTableRowVer1 | GroupMessageTableRowVer2
}
...
func NewLargestGroupMessageTable() (x GroupMessageTableRowVer2) {
	return
}
...
type GroupMessageTableRowVer1 struct {
	ID          int64   `db:"40001"`
	Unk0        int64   `db:"40002"`
	MsgID       int64   `db:"40003"`
	Unk1        int     `db:"40010"`
	...
	GroupID3    int64   `db:"40030"`
	Uin         int64   `db:"40033"` // Uin 一般为QQ号
	Unk14       []byte  `db:"40062"` // 存贮详细表态信息（包括表态表情和表态数量），其数字与QQBOT中表情编号对应（超级表情不在此列表中）
	Unk15       int     `db:"40083"` // 表态表情数量总和
	Unk16       int     `db:"40084"` // 表态表情数量总和
}

type GroupMessageTableRowVer2 struct {
	ID          int64   `db:"40001"`
	Unk0        int64   `db:"40002"`
	MsgID       int64   `db:"40003"`
	Unk1        int     `db:"40010"`
